                ...
                <section className="shopping-cart dark">
                    <div className="container">
                        <div className="block-heading">
                            <h2>Shopping Cart<span className='badge badge-primary' style={{ padding:"5px", backgroundColor:"#f35525", marginLeft:"5px" }}>{totalUniqueItems}</span></h2>
                        </div>
                                                                        ...
                                                                        <div className="col-md-5 product-name">
                                                                            <div className="product-name">
                                                                                ...
                                                                                <div className="product-info">
                                                                                    ...
                                                                                    <div>
                                                                                        Floor:{" "}
                                                                                        <span className="value">{item.Floor}</span>
                                                                                    </div>
                                                                                    <div>
                                                                                        Bedrooms:{" "}
                                ...
                                <div className="col-md-12 col-lg-4">
                                    <div className="summary">
                                        ...
                                        <div className="summary-item">
                                            ...
                                            <span className="price">${(cartTotal - (cartTotal * 0.1)).toFixed(2)}</span>
                                        </div>
                                        <button type="button" className=" main-1 btn-lg btn-block mt-4">
                                            Checkout
                                        </button>
                                    </div>
                                </div>
